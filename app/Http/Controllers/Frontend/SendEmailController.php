...
class SendEmailController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.sendEmails.index', compact('sendEmails'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.sendEmails.create', compact('contacts', 'email_templates', 'users'));
    }
    ...
    public function store(StoreSendEmailRequest $request)
    {
        ...
        return redirect()->route('frontend.send-emails.index');
    }
    ...
    public function edit(SendEmail $sendEmail)
    {
        ...
        return view('frontend.sendEmails.edit', compact('contacts', 'email_templates', 'sendEmail', 'users'));
    }
    ...
    public function show(SendEmail $sendEmail)
    {
        ...
        return view('frontend.sendEmails.show', compact('sendEmail'));
    }
